...
class ListIndexSetsResponse$Type extends MessageType<ListIndexSetsResponse> {
    constructor() {
        super("elephant.index.ListIndexSetsResponse", [
            { no: 1, name: "index_sets", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => IndexSet },
...
class MultiSearchRequest$Type extends MessageType<MultiSearchRequest> {
    constructor() {
        super("elephant.index.MultiSearchRequest", [
            { no: 1, name: "queries", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QueryRequestV1 }
        ]);
    }
...
class MultiSearchResponse$Type extends MessageType<MultiSearchResponse> {
    constructor() {
        super("elephant.index.MultiSearchResponse", [
            { no: 1, name: "results", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QueryResponseV1 }
        ]);
    }
...
class QueryRequestV1$Type extends MessageType<QueryRequestV1> {
    constructor() {
        super("elephant.index.QueryRequestV1", [
            ...
            { no: 5, name: "sort", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SortingV1 },
...
class BoolQueryV1$Type extends MessageType<BoolQueryV1> {
    constructor() {
        super("elephant.index.BoolQueryV1", [
            { no: 1, name: "must", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QueryV1 },
            { no: 2, name: "must_not", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QueryV1 },
            { no: 3, name: "should", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QueryV1 },
            { no: 4, name: "filter", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => QueryV1 },
...
class HitsV1$Type extends MessageType<HitsV1> {
    constructor() {
        super("elephant.index.HitsV1", [
            ...
            { no: 3, name: "hits", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HitV1 }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for elephant.index.HitV1.fields");
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = FieldValuesV1.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for elephant.index.HitV1.source");
            }
        }
        map[key ?? ""] = val ?? FieldValuesV1.create();
    }
...
class GetMappingsResponseV1$Type extends MessageType<GetMappingsResponseV1> {
    constructor() {
        super("elephant.index.GetMappingsResponseV1", [
            { no: 1, name: "properties", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MappingPropertyV1 }
        ]);
    }
...
class MappingPropertyV1$Type extends MessageType<MappingPropertyV1> {
    constructor() {
        super("elephant.index.MappingPropertyV1", [
            ...
            { no: 4, name: "fields", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => MappingFieldV1 }
        ]);
    }
...
class PollSubscriptionRequest$Type extends MessageType<PollSubscriptionRequest> {
    constructor() {
        super("elephant.index.PollSubscriptionRequest", [
            { no: 1, name: "subscriptions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SubscriptionReference },
...
class PollSubscriptionResponse$Type extends MessageType<PollSubscriptionResponse> {
    constructor() {
        super("elephant.index.PollSubscriptionResponse", [
            { no: 1, name: "result", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SubscriptionPollResult },
...
class SubscriptionPollResult$Type extends MessageType<SubscriptionPollResult> {
    constructor() {
        super("elephant.index.SubscriptionPollResult", [
            ...
            { no: 2, name: "items", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => SubscriptionItem }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = FieldValuesV1.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for elephant.index.SubscriptionItem.fields");
            }
        }
        map[key ?? ""] = val ?? FieldValuesV1.create();
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = FieldValuesV1.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for elephant.index.SubscriptionItem.source");
            }
        }
        map[key ?? ""] = val ?? FieldValuesV1.create();
    }
